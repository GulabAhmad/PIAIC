...
function calcPercentage(obtainedmarks:number,totalnumbers:number) {
    var result:number = obtainedmarks/totalnumbers*100;
    console.log(result);
...
function checkDivisibilty(num1:number) {
    if (num1 % 3 == 0) {
...
var unitConsume:number = 500;
var unitPrice : number = 27;
var amount:number = unitConsume*unitPrice;
var tax10:number = amount * 10 / 100;
var tax15:number = amount * 15 / 100;
var tax25:number = amount * 25 / 100;
if (unitConsume<=100) {
...
var getDays:number = 17;
var convertIntoweeks:number = Math.floor(getDays/7);
